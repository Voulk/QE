...
There are five possible procs, based on which gem types you have equipped. Your proc rate is divided by the number of Loa you can call, so there's no inherant advantage to socketing many gem types. If you have the listed gem, then the proc is added to the pool. Simple as that.
